  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'home':
        return (
          <Center>
            <Image src="/images/MM_Concierge_red ER.png" maxWidth={{ base: '100%', md: '80%', lg: '60%' }} height="auto" objectFit="contain" alt="Homepage" />
          </Center>
        );
      case 'services':
        return (
          <Center flexDirection="column">
            <Image src="./images/services_available.png" maxWidth={{ base: '100%', md: '80%', lg: '60%' }} height="auto" objectFit="contain" alt="Services Available 1" mb={4} />
      ...
      case 'difference':
        return (
          <Center flexDirection="column">
            <Image src="./images/What_makes_MMC_different.png" maxWidth={{ base: '100%', md: '80%', lg: '60%' }} height="auto" objectFit="contain" alt="Difference Image 1" mb={4} />
      ...
      case 'why':
        return (
          <Center flexDirection="column">
            <Image src="./whyIdoThis.png" maxWidth={{ base: '90%', md: '80%', lg: '60%' }} height="auto" objectFit="contain" alt="Why I Do This Image 1" mb={4} />
            <Image src="./whyIdoThisText.png" maxWidth={{ base: '90%', md: '80%', lg: '60%' }} height="auto" objectFit="contain" alt="Why I Do This Image 2" />
          </Center>
        );
      default:
        return (
          <Center>
            <Image src="./homepage.png" maxWidth={{ base: '90%', md: '80%', lg: '60%' }} height="auto" objectFit="contain" alt="Homepage" />
          </Center>
        );
    }
  };
