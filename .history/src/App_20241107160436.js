  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'home':
        return (
          <Center flexDirection="column">
            <Image src="/images/MM_Concierge_red ER.png" maxWidth='500px' height="auto" objectFit="contain" alt="Homepage" />
            <HomePage />
          </Center>
        );
      case 'services':
        return (
          <Center flexDirection="column">
            <Image src="./images/services_available.png" maxWidth='500px' height="auto" objectFit="contain" alt="Services Available 1" mb={4} />
            <ServicesAvailable/ >
          </Center>
        );
      case 'difference':
        return (
          <Center flexDirection="column">
            <Image src="./images/What_makes_MMC_different.png" maxWidth='500px' height="auto" objectFit="contain" alt="Difference Image 1" mb={4} />
      ...
      case 'why':
        return (
          <Center flexDirection="column">
            <Image src="./whyIdoThis.png" maxWidth='500px' height="auto" objectFit="contain" alt="Why I Do This Image 1" mb={4} />
            <MMCWhyIDoThis />
          </Center>
        );
      default:
        return (
          <Center>
            <Image src="./logo2.png" maxWidth='500px' height="auto" objectFit="contain" alt="Homepage" mb={4} />
            <HomePage />
          </Center>
        );
    }
